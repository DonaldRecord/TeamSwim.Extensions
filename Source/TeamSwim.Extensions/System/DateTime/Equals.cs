...
namespace System
{
    ...
    public static partial class DateTimeExt
    {
        ...
        /// <param name="inclusive">Value indicating the difference between the two <see cref="DateTime"/>s will return <see langword="true"/> if equal to the <paramref name="delta"/> <see cref="TimeSpan"/>.</param>
        ...
        [Pure, PublicAPI]
        public static bool Equals(this DateTime dateTimeA, DateTime dateTimeB, TimeSpan delta, bool inclusive)
        {
