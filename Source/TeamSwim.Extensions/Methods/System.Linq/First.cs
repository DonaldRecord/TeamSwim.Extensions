...
namespace System.Linq
{
    ...
    {
        /// <summary>
        ///     Returns the first element of a sequence, and throws an exception if there are no elements in the sequence.
        /// </summary>
        /// <typeparam name="T">The type of the elements of <paramref name="source" />.</typeparam>
        /// <param name="source">Sequence to return the first element of.</param>
