...
namespace System
{
    ...
    public static partial class Int64Ext
    {
        ...
        /// <param name="inclusive">When set to true, the <paramref name="value"/> is allowed to match the <paramref name="start"/> or <paramref name="end"/> value. The default value is <see langword="true"/>.</param>
